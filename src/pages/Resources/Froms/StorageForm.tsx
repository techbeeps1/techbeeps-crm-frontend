        ...
        <>
            ...
            <Dialog open={open} onClose={handleCancel} fullWidth maxWidth="md">
                ...
                <DialogTitle className="flex justify-between items-center">
                    <span className="font-semibold text-primary mb-1 mt-4" style={{ fontSize: '28px' }}>{data ? "Update" : 'Add New'} Storage</span>
                ...
                <DialogContent sx={{ padding: '16px' }}>
                    <p className="mb-8">
                        You can add storage here, it is also possible to fill in the form below.
                    </p>
                    {loading && <Loader />}
                    <div className="w-full">
                        <div className="mb-3">
                            <label className="block text-md font-medium pb-2">Storage Number*</label>
                            <Controller
                                name="storageCode"
                                control={control}
                                defaultValue=''
                            ...
                            />
                            {errors.storageCode && <p className="text-red-500 text-sm">{errors.storageCode.message}</p>}
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    ...
                                    >
                                        ...
                                        <option value="Distributed Storage">Distributed Storage</option>
                                    </select>
                                )}
                            />
                        ...
                        <div className="mb-3">
                            <label className="block text-md font-medium pb-2">Contents*</label>
                            <Controller
                                name="cubicMeter"
                                control={control}
                                defaultValue=''
                            ...
                            />
                            {errors.cubicMeter && <p className="text-red-500 text-sm">{errors.cubicMeter.message}</p>}
                        </div>
                        <div className="mb-3">
                            <label className="block text-md font-medium pb-1">Is the Storage is Your own possession?</label>
                        ...
                        <div className="mb-3">
                            <label className="block text-md font-medium pb-2">Storage Location*</label>
                            <Controller
                                ...
                                render={({ field }) => (
                                    ...
                                    >
                                        ...
                                        {storageLocation && storageLocation.map((item: any) =>
                                            <option key={item._id} value={item._id}>{item.name}</option>
                                        )}
                                    </select>
                                )}
                            />
                            {errors.storageLocation && <p className="text-red-500 text-sm">{errors.storageLocation.message}</p>}
                        </div>
                    </div>
