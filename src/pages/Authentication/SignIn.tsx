...
const SignIn: React.FC<SignInProps> = ({ signup, setsignup, onResetPassword }) => {
  ...
  const handleLogin = async (data: LoginFormInputs) => {
    ...
    try {
      ...
      notifyError(`login failed: ${error?.response?.data?.msg}`)
    }finally{
      setLoading(false);
    }
  };
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-4">
              ...
              <div className="relative">
                <input
                  type="email" // Change type to "email" for better input validation
                  {...register('email', {
                ...
                />
                {errors.email && ( // Use errors.email instead of errors.username
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <div className="forget mt-2">
                  <a onClick={() => onResetPassword()} style={{ cursor: 'pointer' }} >forget password ?</a>
                </div>
              </div>
            </div>

            {/* Submit Button */}
            <button type="submit" className="bg-primary text-white block w-full rounded-sm p-2 mb-3">
              Login
            </button>
